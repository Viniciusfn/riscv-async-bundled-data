...
# Generated on: Fri Jun 26 16:47:19 -03 2026 (Fri Jun 26 19:47:19 UTC 2026)
...
set logfile ../logs/lec/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ariscv -revised fv_map
...
read_library -liberty -both \
    /Tools/pdks/gpdk045_v_6_0/gsclib045_all_v4_4/gsclib045/timing/slow_vdd1v0_basicCells.lib \
    /Tools/pdks/gpdk045_v_6_0/gsclib045_all_v4_4/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
add_search_path ../rtl/src/ -design -golden
read_design -enumconstraint -define SYNTHESIS -define PW_AWARE -define PROTO_LC -define TOKENS_2 -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/src/ariscv_params_pkg.sv ../rtl/src/alu.sv ../rtl/src/ariscv.sv ../rtl/src/ariscv_ctrlpath.sv ../rtl/src/ariscv_dec.sv ../rtl/src/ariscv_dtpath.sv ../rtl/src/ariscv_exec.sv ../rtl/src/ariscv_fetch.sv ../rtl/src/ariscv_mem.sv ../rtl/src/ariscv_wb.sv ../rtl/src/c_element.sv ../rtl/src/ctrl_unit.sv ../rtl/src/delay.sv ../rtl/src/extend.sv ../rtl/src/reg_file.sv ../rtl/src/ctrl_fork.sv ../rtl/src/ctrl_join.sv ../rtl/src/c_element_asym.sv ../rtl/src/lc_cell.sv
elaborate_design -golden -root {ariscv} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ariscv/fv_map.v.gz
...
#add_name_alias fv/ariscv/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.ariscv.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ariscv.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ariscv.rtl.fv_map.rpt
